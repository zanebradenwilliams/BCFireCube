...
##Initialization: download data from https://open.canada.ca/data/en/dataset/c688b87f-e85f-4842-b0e1-a8f79ebf1133

##Store unzipped data in /BCFireCube/Data/2010LandCover
...
lco <- rast("Data/2010LandCover/landcover-2010-classification.tif")
...
#label index data
docs <- docs %>% mutate(landcover = Canada2010, `Land Cover Class` = recode(
  Canada2010, `1` = "Temperate or sub-polar needleleaf forest", `2` = "Sub-polar taiga needleleaf forest",
...
write.csv(docs, "Documentation/2010_bcrast_landcover.csv", row.names = FALSE)

## Step 6: Save as NetCDF
writeCDF(lco, "Products/2010_bcrast_landcover.nc", varname="landcover", longname="Land Cover Code", unit = "code")
