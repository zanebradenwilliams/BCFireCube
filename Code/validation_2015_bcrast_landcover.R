...
#raw pstahead data
lco_raw <- rast("Data/2015LandCover/landcover-2015-classification.tif")
...
for(i in 1:30){
  ...
  vals_raw <- vals_raw %>% rename(landcover_raw = Canada2015) %>% 
...
#save data
write.csv(results, "Data/Validation/validation_2015_bcrast_landcover.csv", row.names = FALSE)
