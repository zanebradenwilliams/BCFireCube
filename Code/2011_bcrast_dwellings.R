...
dwl <- read.csv("Data/2011Census/2011Census.csv")
...
writeCDF(bnd, "Products/2011_bcrast_dwellings.nc", varname="dwellings", longname="Dwellings per Square Kilometer", unit = "dwellings/km^2")
