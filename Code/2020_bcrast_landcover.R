...
##Initialization: download data from https://open.canada.ca/data/en/dataset/ee1580ab-a23d-4f86-a09b-79763677eb47

##Store unzipped data in /BCFireCube/Data/2020LandCover
...
lco <- rast("Data/2020LandCover/landcover-2020-classification.tif")
...
#label index data
docs <- docs %>% mutate(landcover = Canada2020, `Land Cover Class` = recode(
  Canada2020, `1` = "Temperate or sub-polar needleleaf forest", `2` = "Sub-polar taiga needleleaf forest",
...
write.csv(docs, "Documentation/2020_bcrast_landcover.csv", row.names = FALSE)

## Step 6: Save as NetCDF
writeCDF(lco, "Products/2020_bcrast_landcover.nc", varname="landcover", longname="Land Cover Code", unit = "code")
