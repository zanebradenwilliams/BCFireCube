...
##Initialization: download data from https://www12.statcan.gc.ca/census-recensement/2011/geo/bound-limit/bound-limit-2006-eng.cfm
##and https://www12.statcan.gc.ca/census-recensement/2011/geo/ref/att-eng.cfm?year=2006

##Store unzipped data in /BCFireCube/Data/2006Census
...
pop <- read_excel("Data/2006Census/92-151-XBB_XLSX.xlsx", col_names = FALSE)
...
write.csv(pop, "Data/2006Census/2006Census.csv", row.names = FALSE)
...
writeCDF(bnd, "Products/2006_bcrast_population.nc", varname="population", longname="Population per Square Kilometer", unit = "population/km^2")
