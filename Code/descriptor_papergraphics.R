...
periods <- data.frame(variable = c("Wildfire Perimeters", "Incident Locations",
                                   "Elevation", "Slope", "Ownership", "Land Cover", "Land Cover", "Land Cover",
                                   "Wildland-Urban Interface", "Biogeoclimatic Code", "Natural Disturbance Type",
                      ...
                      start = c(1916.75, 1949.75,
                                1916.75, 1916.75, 2022.75, 2018.75, 2013.75, 2005.75,
                                2015.75, 2016.75, 2016.75,
                                2019.75, 2019.75, 2014.75, 2009.75, 2001.75,
                                2019.75, 2014.75, 2009.75, 2001.75,
                                2020.75, 2020.75),
                      end = c(2025.25, 2025.25,
                              2025.25, 2025.25, 2025.25, 2024.25, 2018.75, 2013.75,
                              2024.25, 2025.25, 2025.25,
                              2025.25, 2025.25, 2019.75, 2014.75, 2009.75,
                              2025.25, 2019.75, 2014.75, 2009.75,
                              2023.25, 2023.25),
                      fill = c("#0D3E1F", "#144826",
                               "#1A522E", "#215C35", "#27663D", "#2E7044", "#2E7044", "#2E7044",
                               "#347A4B", "#3B8353", "#418D5A",
...
yearplot <- ggplot() +
  ...
  geom_segment(aes(x = 1915.7, xend = 1915.7, y = 0.6, yend = 14.4), colour = "black", linewidth = 0.5) +
  geom_segment(aes(x = 2027, xend = 2027, y = 0.6, yend = 14.4), colour = "black", linewidth = 0.5) +
  geom_segment(aes(x = 1915.7, xend = 2027, y = 14.4, yend = 14.4), colour = "black", linewidth = 0.5) +
  ...
  scale_y_continuous(breaks = 1:14, labels = c("Forest Biomass", "Forest Age", "Dwellings", "Population", "Fuel Type",
                                               "Natural Disturbance Type", "Biogeoclimatic Code", "Wildland-Urban Interface", 
                                               "Land Cover", "Ownership", "Slope", "Elevation",
                                               "Incident Locations", "Wildfire Perimeters"),
                     position = "right", limits = c(0.6, 14.4), expand = expansion(mult = 0, add = 0)) +
...
#save plot
ggsave("Data/bcfire_years.pdf", yearplot, width = 6, height = 4, units = "in", dpi = 320)
